...
public class PaginaProveedores extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(new TitledBorder(null, "Ingrese detalles del proveedor", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)));
        		...
        		.addGroup(jPanel1Layout.createSequentialGroup()
        			...
        			.addGroup(jPanel1Layout.createParallelGroup(Alignment.LEADING)
        				...
        				.addGroup(jPanel1Layout.createSequentialGroup()
        					...
        					.addPreferredGap(ComponentPlacement.RELATED)
        					.addGroup(jPanel1Layout.createParallelGroup(Alignment.LEADING)
        						.addComponent(locationText, GroupLayout.DEFAULT_SIZE, 249, Short.MAX_VALUE)
        						.addComponent(nameText, GroupLayout.DEFAULT_SIZE, 249, Short.MAX_VALUE)
        						.addComponent(phoneText, GroupLayout.PREFERRED_SIZE, 153, GroupLayout.PREFERRED_SIZE)))
        				.addGroup(jPanel1Layout.createSequentialGroup()
        					.addGroup(jPanel1Layout.createParallelGroup(Alignment.LEADING)
        					...
        					.addGap(18)
        					.addGroup(jPanel1Layout.createParallelGroup(Alignment.LEADING)
        						.addComponent(debitText, GroupLayout.PREFERRED_SIZE, 161, GroupLayout.PREFERRED_SIZE)
        						.addComponent(creditText, GroupLayout.PREFERRED_SIZE, 246, GroupLayout.PREFERRED_SIZE))))
        			.addContainerGap())
        );
