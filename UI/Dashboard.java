...
public class Dashboard extends javax.swing.JFrame {
     ...
     */
    public Dashboard(String username, String userType, UsuarioDTO userDTO) {
        initComponents();
        ...
        this.addWindowListener(new WindowAdapter() {
            ...
            public void windowClosing(WindowEvent e) {
                ...
                new UsuarioDAO().addUserLogin(userDTO);
    ...
    private void initComponents() {
        ...
        stockButton.setBackground(new Color(0, 0, 128));
        ...
        suppButton.setBackground(new Color(0, 0, 128));
        ...
        logsButton.setBackground(new Color(0, 0, 128));
